...
CREATE USER tendermint with password 'password';
DROP DATABASE IF EXISTS tendermintexplorer;
CREATE DATABASE tendermintexplorer owner tendermint;
...
ALTER table orderer owner to tendermint;
...
ALTER table write_lock owner to tendermint;
Alter sequence write_lock_write_lock_seq restart with 2;

GRANT SELECT, INSERT, UPDATE,DELETE ON ALL TABLES IN SCHEMA PUBLIC to tendermint;
